...
class T3(nn.Module) : 
    ...
    def __init__(
        ...
        self.llama_transformer_model : LlamaModel = LlamaModel(self.cfg)
    ...
    def forward(
        ...
        *,
        ...
        tfmr_out = self.llama_transformer_model.forward(
            input_ids=None,
        ...
        hidden_states = tfmr_out.hidden_states[-1]  # final llama_transformer_model layer output, (B, seq, dim)
    ...
    def inference(
        ...
        *,
        ...
        # Note the llama-specific logic. Other llama_transformer_model types can be added later.
        ...
        if not self.compiled:
            ...
            patched_model = T3HuggingfaceBackend(
                config=self.cfg,
                llama=self.llama_transformer_model,
